const Contact=()=>{
    return(
        <div className="font-serif">
            <h1 className="m-4 text-3xl text-center font-semibold underline">Contact Us Page✍️</h1>
            <h2 className="m-4 font-serif font-semibold text-2xl">Get in touch with me</h2>
            <h3 className="m-4 font-serif font-semibold text-2xl">📱-8319999358</h3>
